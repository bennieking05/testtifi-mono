...
gcloud run deploy testifi-summarize-worker \
    ...
    --cpu 2 \
    --timeout 3600 \
    --set-env-vars "NODE_ENV=production,WORKER_CONCURRENCY=1,PAGE_RANGE_SIZE=5,AZURE_OPENAI_DEPLOYMENT_NAME=gpt-5.4-testifi,AZURE_API_VERSION=2025-01-01-preview,BASE_URL=https://app.testifi.ai" \
